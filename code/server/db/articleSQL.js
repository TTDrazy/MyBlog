const ArticleSQL = {
    ...
    queryAllHasClassifyName: ` SELECT article.id,article.title,article.content,article.date,article.classify_id,classify.name AS classifyName 
    ...
    queryArticleListByIdHasClassifyName: classifyId => `SELECT article.id,article.title,article.content,article.date,article.classify_id,classify.name AS classifyName 
    ...
    queryByIdHasClassifyName: id => `SELECT article.id,article.title,article.content,article.date,article.classify_id,classify.name AS classifyName 
